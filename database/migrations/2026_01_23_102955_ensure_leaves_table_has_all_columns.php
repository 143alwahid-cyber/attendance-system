...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'pgsql') {
            // For PostgreSQL (Supabase), drop and recreate to ensure correct structure
            DB::statement('DROP TABLE IF EXISTS leaves CASCADE');
            ...
            // Create indexes
            DB::statement('CREATE INDEX IF NOT EXISTS leaves_employee_id_status_idx ON leaves(employee_id, status)');
            DB::statement('CREATE INDEX IF NOT EXISTS leaves_leave_date_idx ON leaves(leave_date)');
        } else {
